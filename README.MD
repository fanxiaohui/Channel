...
- [socket相关的函数](https://github.com/Haldir65/Channel/blob/master/socket.MD)
...
- [C语言中如何创建和使用第三方库](https://github.com/Haldir65/Channel/blob/master/howToUseLibraryInC.MD)
